...
import React4__default, { memo, useRef, useLayoutEffect, createElement } from 'react';
import '@million/lint/devtools';
...
var init_constants = __esm({
  "runtime/src/core/utils/constants.ts"() {
    _null = null;
    isSSR = typeof window === "undefined" || !React4.useRef;
    useIsomorphicLayoutEffect = isSSR ? React4.useEffect : React4.useLayoutEffect;
...
var init_react_internals = __esm({
  "runtime/src/core/utils/react-internals.ts"() {
    ...
    init_src();
    init_constants();
    FiberContext = React4.createContext(_null);
    FiberProvider = class extends React4.Component {
      constructor(props) {
        super(props);
        init(props);
      }
    ...
    SECRET_INTERNALS = React4?.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
    CLIENT_INTERNALS = React4?.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;
    getFiberDEV = () => {
  ...
  "runtime/src/core/dev/use-ses-shim.js"(exports) {
    {
      (function() {
        ...
        var ReactSharedInternals = React4__default.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED || {
        ...
        var useState3 = React4__default.useState, useEffect3 = React4__default.useEffect, useLayoutEffect3 = React4__default.useLayoutEffect, useDebugValue = React4__default.useDebugValue;
        var didWarnOld18Alpha = false;
        var didWarnUncachedGetSnapshot = false;
        function useSyncExternalStore2(subscribe, getSnapshot, getServerSnapshot) {
          {
            if (!didWarnOld18Alpha) {
              if (React4__default.startTransition !== void 0) {
        ...
        var useSyncExternalStore$2 = React4__default.useSyncExternalStore !== void 0 ? React4__default.useSyncExternalStore : shim;
    ...
    try {
      void (async () => {
        ...
        const Select = ({ isDragging }) => {
          ...
          const [isHovered, setIsHovered] = React4__default.useState(false);
          if (!data.destroy)
            destroySelections();
          return /* @__PURE__ */ React4__default.createElement(
            ...
            /* @__PURE__ */ React4__default.createElement(
              ...
              /* @__PURE__ */ React4__default.createElement("path", { d: "M5 3a2 2 0 0 0-2 2" }),
              /* @__PURE__ */ React4__default.createElement("path", { d: "M19 3a2 2 0 0 1 2 2" }),
              /* @__PURE__ */ React4__default.createElement("path", { d: "m12 12 4 10 1.7-4.3L22 16Z" }),
              /* @__PURE__ */ React4__default.createElement("path", { d: "M5 21a2 2 0 0 1-2-2" }),
              /* @__PURE__ */ React4__default.createElement("path", { d: "M9 3h1" }),
              /* @__PURE__ */ React4__default.createElement("path", { d: "M9 21h2" }),
              /* @__PURE__ */ React4__default.createElement("path", { d: "M14 3h1" }),
              /* @__PURE__ */ React4__default.createElement("path", { d: "M3 9v1" }),
              /* @__PURE__ */ React4__default.createElement("path", { d: "M21 9v2" }),
              /* @__PURE__ */ React4__default.createElement("path", { d: "M3 14v1" })
            ),
        ...
        const Scan = ({ isDragging }) => {
          ...
          return /* @__PURE__ */ React4__default.createElement(
            ...
            /* @__PURE__ */ React4__default.createElement(
              ...
              /* @__PURE__ */ React4__default.createElement("path", { d: "M3 7V5a2 2 0 0 1 2-2h2" }),
              /* @__PURE__ */ React4__default.createElement("path", { d: "M17 3h2a2 2 0 0 1 2 2v2" }),
              /* @__PURE__ */ React4__default.createElement("path", { d: "M21 17v2a2 2 0 0 1-2 2h-2" }),
              /* @__PURE__ */ React4__default.createElement("path", { d: "M7 21H5a2 2 0 0 1-2-2v-2" }),
              /* @__PURE__ */ React4__default.createElement("circle", { cx: "12", cy: "12", r: "1" }),
              /* @__PURE__ */ React4__default.createElement("path", { d: "M5 12s2.5-5 7-5 7 5 7 5-2.5 5-7 5-7-5-7-5" })
            ),
        ...
        const Replay = ({ isDragging }) => {
          ...
          return /* @__PURE__ */ React4__default.createElement(
            ...
            data.replay === "recording" ? /* @__PURE__ */ React4__default.createElement(
              "svg",
              {
                xmlns: "http://www.w3.org/2000/svg",
                width: "16",
              ...
              /* @__PURE__ */ React4__default.createElement("rect", { x: "14", y: "4", width: "4", height: "16", rx: "1" }),
              /* @__PURE__ */ React4__default.createElement("rect", { x: "6", y: "4", width: "4", height: "16", rx: "1" })
            ) : data.replay === "playing" ? /* @__PURE__ */ React4__default.createElement(
              "svg",
              {
                xmlns: "http://www.w3.org/2000/svg",
                width: "16",
              ...
              /* @__PURE__ */ React4__default.createElement("path", { d: "M18 6 6 18" }),
              /* @__PURE__ */ React4__default.createElement("path", { d: "m6 6 12 12" })
            ) : /* @__PURE__ */ React4__default.createElement(
              "svg",
              {
                xmlns: "http://www.w3.org/2000/svg",
              ...
              /* @__PURE__ */ React4__default.createElement("path", { d: "m16 13 5.223 3.482a.5.5 0 0 0 .777-.416V7.87a.5.5 0 0 0-.752-.432L16 10.5" }),
              /* @__PURE__ */ React4__default.createElement("rect", { x: "2", y: "6", width: "14", height: "12", rx: "2" })
            ),
            isHovered && !isDragging ? data.replay === "recording" ? "Stop recording" : data.replay === "playing" ? "Exit recording" : "Record" : ""
          );
        };
        const App = () => {
          const [isDragging, setIsDragging] = React4__default.useState(false);
          const [position, setPosition] = React4__default.useState(() => {
          ...
          const ref = React4__default.useRef(null);
          const prevItems = React4__default.useRef(0);
          const data = (0, import_use_ses_shim.useSyncExternalStore)(
            toolbarStore.subscribe,
            toolbarStore.getSnapshot
          );
          const dragTimeoutRef = React4__default.useRef(null);
          const dragStyles = {
          ...
          const onWindowResize = React4__default.useCallback(() => {
          ...
          if (data.state === "error") {
            return /* @__PURE__ */ React4__default.createElement(
              ...
              /* @__PURE__ */ React4__default.createElement(
                ...
                /* @__PURE__ */ React4__default.createElement("div", { className: "error-circle" })
              ),
              /* @__PURE__ */ React4__default.createElement(
                "a",
                {
...
${(DEV.toolbarStore.data.sessions || []).map(
              ...
              /* @__PURE__ */ React4__default.createElement("div", { className: "div" }),
              " ",
              /* @__PURE__ */ React4__default.createElement(
                "div",
                {
          ...
          return /* @__PURE__ */ React4__default.createElement(
            ...
            /* @__PURE__ */ React4__default.createElement(Radar_default, { frames: 30, speed: 17e-4, size: 20, inset: 3 }),
            /* @__PURE__ */ React4__default.createElement(
              "span",
              {
                onDoubleClick: () => {
            ...
            /* @__PURE__ */ React4__default.createElement(Select, { isDragging }),
            /* @__PURE__ */ React4__default.createElement(Scan, { isDragging }),
            /* @__PURE__ */ React4__default.createElement(Replay, { isDragging })
          );
        };
    ...
    `;
          ...
          const majorVersion = Number(React4__default.version.split(".")[0]);
          try {
            if (majorVersion >= 18) {
        ...
        await render(/* @__PURE__ */ React4__default.createElement(App, null));
      })();
    } catch (_) {
    }
  }
});
var noop, onCommitFiberRoot, dispatcherRefs, DEVTOOLS_HOOK, patchRenderer, SIGKILL, IS_REACT_19, MillionLintProvider, batchIndexLookup, metadataLookup, batch, inited, session, url, apiKey, buildId, commitHash, onRender, events2, eventId, eventIndex, commitIndex, commits, pendingRequests, _proxySessionId, getMetadata, UNSTABLE_TYPES, getChange, captureDeps, captureProps, captureValue, captureFunction, MillionProfiler, captureJSX, captureHook, componentIds, captureBaseline, $$, useCapture, useCount, mergeChange, reportRender, flush, debouncedFlush, reset, registerMetadata, getNavigationEntry, getActivationStart, getNavigationType, observe, getKeyFromEl, initWebVitals, init;
var init_core = __esm({
  "runtime/src/core/index.ts"() {
    ...
    IS_REACT_19 = React4.version.startsWith("19");
    MillionLintProvider = FiberProvider;
    ...
    getChange = (prevValue, nextValue, shallow) => {
      ...
      if (!shallow || React4.isValidElement(nextValue)) {
    ...
    MillionProfiler = React4.forwardRef(
      (_props, forwardedRef) => {
        let { children, _k, _l, _i, _l2, ...parentProps } = _props;
        let prevRef = React4.useRef();
        ...
        let element = (forwardedRef || childrenRef) && isChildrenForwardRef ? React4.cloneElement(
          children,
    ...
    captureJSX = (key, element, instancesIndex, loc, secondaryLoc) => {
      ...
      return /* @__PURE__ */ React4.createElement(MillionProfiler, {
    ...
    captureBaseline = (key, canRunHooks2, reference, data, loc) => {
      ...
      if (canRunHooks2) {
        cache = React4.useState(() => new _Array(data.c))[0];
        let fiber = useFiber();
        if (fiber && data.v) {
    ...
    $$ = (value, kind, key, loc, secondaryLoc, locs, index, mountInfo) => {
      if (isSSR || SIGKILL)
        return value;
    ...
    useCapture = (value, key, loc, index, mountInfo) => {
    ...
    useCount = (message, key, loc, index, mountInfo) => {
    ...
    registerMetadata = (key, size, isComponent, _DEV) => {
      if (isSSR || SIGKILL)
        return;
